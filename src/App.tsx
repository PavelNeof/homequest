            ...
            {!isMap && (
              <>
                ...
                {questions['1'] && <div className="block">
                  <label className="label">У тебя получилось! Теперь ты понимаешь, как это работает. Открыт проход на кухню.
                    Теперь маленький храбрый эльф нужно подкрепиться, чтоб набраться сил для дальнейшего путешествия. А т.к. это инопланетные ингредиенты,
                    то нужен тот, кто в этом разбирается. Может коты?</label>
                ...
                {questions['2'] && <div className="block">
                  <label className="label">Маленький, славный эльф справился со своим заданием! Открылась новая секция - Библиотека.
                    Ты должен найти самую милую девушку, встать напротив неё и у неё над головой найдёшь следующую зацепку.
                  </label>
                ...
                {questions['3'] && <div className="block">
                  <label className="label">Отлично, успешно разблокировалось всё помещение данной секции. Злых инопланетян до сих пор не видно, как и следов Санты.
                    Как-то похолодало в помощении, хочется ччем-то укрыться, тебе так не кажется?
                  </label>
                ...
                {questions['5'] && <div className="block">
                  <label className="label">ВИУ-ВИУ-ВИУ! Сработала сигнализация и твою дорогу перегородил страж коробля - Сыроликий Сказилибоб.
                    ...
                    удовольствием, очень страшный тип. Тебе придётся сразить его, храбрый Эльф. Я просканировал помещение, позади тебя есть небольшой
                    шкаф, оттуда исходит энергия легендарного оружия - Жало Аристарха. Необходимо будет метнуть его Сказалибобу точно в морду с растояния
                    2ух метров. Ты справишься! Эльфы просто так не сдаются!
                  </label>
                ...
                {questions['8'] && <div className="block">
                  <label className="label">Поздравляю тебя с победой, храбрый, маленький эльф. Ты снял последний борьер и теперь можешь идти и освобождать
                    ...
                    ты найдёшь коробочки, в одной из них Злодей спрятал Санту. Освободи его и прими презент в честь его спасения)
                  </label>
                  <label>
                    конец =)
                  </label>
